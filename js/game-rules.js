...
const gameRules = {
    ...
    klotskiGame: {
        ...
        content: `
            <div class="rules-content">
                <h3>🎯 游戏目标</h3>
                <p>滑动数字方块，将所有数字按从小到大的顺序排列整齐！</p>
                
                <h3>📖 基本规则</h3>
                <ul>
                    <li>🔢 网格中有N×N-1个数字方块和1个空位</li>
                    <li>👆 点击空位旁边的方块，它会滑到空位上</li>
                    <li>🎯 将所有数字按顺序排列，空位在右下角即为完成</li>
                    <li>⏱️ 系统会记录你的用时和步数</li>
                    <li>💯 效率值 = (时间÷60) × 步数，数值越小越好</li>
                </ul>
                
                <h3>🎮 难度说明</h3>
                <ul>
                    <li><strong>简单模式（3×3）</strong>：8个数字，适合新手练习</li>
                    <li><strong>普通模式（4×4）</strong>：15个数字，考验逻辑思维</li>
                    <li><strong>困难模式（5×5）</strong>：24个数字，需要规划路径</li>
                    <li><strong>极难模式（6×6）</strong>：35个数字，挑战大师级难度</li>
                </ul>
                
                <h3>🎮 怎么玩</h3>
                <ol>
                    <li>选择难度等级（建议从3×3开始）</li>
                    <li>查看被打乱的数字方块</li>
                    <li>点击空位旁边的方块进行移动</li>
                    <li>逐步将数字排列整齐</li>
                    <li>完成后查看你的用时、步数和效率值</li>
                </ol>
                
                <h3>💡 解题技巧</h3>
                <ul>
                    <li><strong>从上往下</strong>：先排好第一行，再排第二行</li>
                    <li><strong>角落策略</strong>：利用角落进行方块循环移动</li>
                    <li><strong>耐心思考</strong>：不要急于移动，提前规划路径</li>
                    <li><strong>练习记忆</strong>：记住常用的移动组合</li>
                </ul>
                
                <h3>🏆 最佳记录</h3>
                <p>系统会保存每个难度的最佳步数、最快时间和最高效率。挑战自己，不断突破记录吧！</p>
            </div>
        `
    },
